        ...
        return a.Configuration = function(a) {
            ...
            var h = {
                    ...
                    list: {
                        ...
                        onChooseEvent: function(t) {return t;},
                                        ...
                                        for (var m = 0, n = l.length; n > m && h < c[i].maxListSize; m += 1) e = $("<li><div class='eac-item'></div></li>"),
                                            function() {
                                                ...
                                                e.find(" > div").on("click", function() {
                                                    t.val(f).trigger("change"), w = b, j(b), o.get("list").onClickEvent(), o.get("list").onChooseEvent(t)
                                                }).mouseover(function() {
            ...
            function g() {
                ...
                function d() {
                    t.on("keydown", function(a) {
                        ...
                        13 === a.keyCode && w > -1 && (t.val(o.get("getValue")(v[w])), o.get("list").onKeyEnterEvent(), o.get("list").onChooseEvent(t), w = -1, i(), a.preventDefault())
                    })
                }
