	...
	<div class="header">
		<div class="panel panel-default ">
			<div class="panel-heading">
				<center><h2>User Type Update Page</h2></center>
			</div>
		</div>
	</div>
	...
	<div class="panel-body">
		<div class="col-sm-12">
			<div class="col-sm-2">
				<div class="form-group ">
					<a href="{{route('userTypes.index')}}" class="btn btn-primary ">
		...
		<div class="col-sm-8 col-sm-offset-2">
			<div class="panel panel-default add_body">
				<div class="panel-body">
					@foreach($findUserType as $findvalue)
					<form action="{{route('userTypes.update',[$findvalue->id_user_type])}}" method="POST">

						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						{!! method_field('PUT') !!}

							<div class="form-group add_input{{ $errors->has('user_type') ? ' has-error' : ''}}">
								<label class="col-md-4 control-label">
									<span class="pull-right">User Type</span>
								</label>
								<div class="col-md-6">
									<input type="text" class="form-control" name="user_type" value="{{ $findvalue->user_type}}">
