...
--
-- Host: localhost
-- Generation Time: Jul 31, 2018 at 09:56 AM
...
--
-- Database: `maxpro_aml_salesforce`
--
...
--
-- Table structure for table `approved_exameens`
--

CREATE TABLE `approved_exameens` (
  `id` int(10) UNSIGNED NOT NULL,
  `exam_schedule_id` int(11) NOT NULL,
  `applicant_no` int(11) NOT NULL,
  `training_required` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `approved_exameens`
--

INSERT INTO `approved_exameens` (`id`, `exam_schedule_id`, `applicant_no`, `training_required`, `created_at`, `updated_at`) VALUES
(1, 1, 2, 0, '2018-07-30 08:10:46', '2018-07-30 08:10:46'),
(2, 1, 1, 0, '2018-07-30 08:10:46', '2018-07-30 08:10:46');

-- --------------------------------------------------------

--
-- Table structure for table `approved_trainees`
--

CREATE TABLE `approved_trainees` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `approved_trainees`
--

INSERT INTO `approved_trainees` (`id`, `training_schedule_id`, `applicant_no`, `training_required`, `created_at`, `updated_at`) VALUES
(4, 4, 1, 1, '2018-07-30 07:43:44', '2018-07-30 07:43:44'),
(6, 6, 2, 1, '2018-07-30 07:44:09', '2018-07-30 07:44:09'),
(7, 6, 3, 1, '2018-07-30 07:44:18', '2018-07-30 07:44:18'),
(8, 6, 1, 1, '2018-07-30 08:02:48', '2018-07-30 08:02:48'),
(9, 4, 2, 1, '2018-07-30 08:11:06', '2018-07-30 08:11:06'),
(10, 4, 3, 1, '2018-07-30 08:11:06', '2018-07-30 08:11:06'),
(11, 6, 126, 1, '2018-07-31 00:40:18', '2018-07-31 00:40:18'),
(12, 6, 127, 1, '2018-07-31 00:40:18', '2018-07-31 00:40:18'),
(13, 6, 128, 1, '2018-07-31 00:40:19', '2018-07-31 00:40:19');
...
CREATE TABLE `exam_schedules` (
  `id` int(10) UNSIGNED NOT NULL,
  `exam_schedule_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `exam_schedules` (`id`, `exam_schedule_name`, `description`, `date`, `start_time`, `end_time`, `is_complete`, `created_at`, `updated_at`) VALUES
(1, 'Second ChnagedChnaged', 'DesDesDesDes', '2010-10-10', '22:10', '22:10', 0, '2018-07-30 04:40:45', '2018-07-30 07:00:31'),
(2, 'New Changed', 'Des Changed', '2018-07-13', '12:59', '12:59', 0, '2018-07-30 05:32:05', '2018-07-30 06:59:47');
...
(54, '2018_07_30_070010_create_exam_schedules_table', 22),
(55, '2018_07_30_071352_create_approved_exameens_table', 22),
(56, '2018_07_31_090243_add_nid_validation_column_tbl_ifa_registrations', 23);
...
(79, 'Unassigned', 'unassigned_view', 'Unassigned', 78, 1, 1, NULL, NULL),
(80, 'Converted', 'converted_view', '', 78, 1, 2, NULL, NULL),
(81, 'Highly interested', 'highly_interested_view', '', 78, 1, 3, NULL, NULL),
(82, 'Might invest', 'might_invest_view', '', 78, 1, 4, NULL, NULL),
(83, 'Interested', 'Interested_view', 'Lead menu Interested view', 78, 1, 5, NULL, NULL),
...
(87, 'Update Training Information', 'update_training_view', 'Update Training Information', 73, 1, 4, NULL, NULL),
(88, 'Update Examination Information', 'update_examination_view', 'Update Examination Information', 73, 1, 5, NULL, NULL),
...
(91, 'Approved Application', 'sales_approved_application_view', 'Approved Application, this submenu in an Salesforce Agent menu child.', 90, 1, 2, NULL, NULL),
...
(94, 'IFA Active List', 'ifa_active_list_view', 'IFA Active List', 73, 1, 8, NULL, NULL),
(95, 'IFA Inactive List', 'ifa_inactive_list_view', 'IFA Inactive List', 73, 1, 9, NULL, NULL),
...
--
-- Table structure for table `tbl_bangladesh_bank`
--

CREATE TABLE `tbl_bangladesh_bank` (
...
--
-- Dumping data for table `tbl_bangladesh_bank`
--
...
--
-- Table structure for table `tbl_bangladesh_bank_branch`
--

CREATE TABLE `tbl_bangladesh_bank_branch` (
...
--
-- Dumping data for table `tbl_bangladesh_bank_branch`
--
...
--
-- Table structure for table `tbl_bangladesh_districts`
--

CREATE TABLE `tbl_bangladesh_districts` (
...
--
-- Dumping data for table `tbl_bangladesh_districts`
--
...
--
-- Table structure for table `tbl_bangladesh_divisions`
--

CREATE TABLE `tbl_bangladesh_divisions` (
...
--
-- Dumping data for table `tbl_bangladesh_divisions`
--
...
--
-- Table structure for table `tbl_bangladesh_thanas`
--

CREATE TABLE `tbl_bangladesh_thanas` (
...
--
-- Dumping data for table `tbl_bangladesh_thanas`
--
...
--
-- Table structure for table `tbl_ifa_managment_filter_option`
--

CREATE TABLE `tbl_ifa_managment_filter_option` (
...
--
-- Dumping data for table `tbl_ifa_managment_filter_option`
--
...
CREATE TABLE `tbl_ifa_registrations` (
  `application_no` int(11) UNSIGNED NOT NULL,
  `ifa_reg_id` int(11) NOT NULL,
  `application_status` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `nid_validation_status` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_active` tinyint(4) DEFAULT NULL,
  `is_delete` tinyint(4) DEFAULT NULL,
  `image_ext` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pre_addr_flat_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pre_addr_house_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pre_addr_road_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pre_addr_division_id` int(11) DEFAULT NULL,
  `pre_addr_district_id` int(11) DEFAULT NULL,
  `pre_addr_ps_id` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pre_addr_premise_ownership` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `per_addr_flat_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `per_addr_house_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `per_addr_road_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `per_addr_division_id` int(11) DEFAULT NULL,
  `per_addr_district_id` int(11) DEFAULT NULL,
  `per_addr_ps_id` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `per_addr_premise_ownership` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `latest_degree` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `last_educational_institution` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_job_holder` tinyint(1) DEFAULT '0',
  `organization_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `employee_id_no` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `designation` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `job_holder_department` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_student` tinyint(1) DEFAULT NULL,
  `institution_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `student_id_card_no` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `receive_sales_commission_by` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bank_id` int(11) DEFAULT NULL,
  `bank_branch_id` int(11) DEFAULT NULL,
  `bank_account_no` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bKash_acc_type` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bKash_mobile_no` int(9) DEFAULT NULL,
  `training_status` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `student_department` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_same_as_present_address` tinyint(1) DEFAULT '0',
  `others_nationality` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `others_user_type` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_type_id` int(11) DEFAULT NULL,
  `button_presses` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
(1, 0, 'InProgress', '', '$2y$10$a93hpFOnwb6X6ATwvZVNTedcpuBY0QkflfwZeAIAwUNNclW5onlQy', 'shishir', '', 'ahmed', 717966799, 'abc1@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1754764532', 'Valid', 1, 0, '.jpg', '3443', '344', '12', 4, 1, 'sdjhs', '2', '3443', '344', '12', 2, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454554', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443434', 'Bank', 1, 1, '368436843', 'personal', 0, 'InTraining', '', 0, NULL, NULL, 2, '', NULL, '2018-07-31 03:41:14'),
(2, 0, 'InProgress', '', '$2y$10$gJZ3LuY6qw4kOjtD12YVSuAww6Z9862K11rPgShr4cqq6QfQTE.uC', 'anup', 'kumar', 'kar', 747966790, 'abc2@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '2754764532', NULL, 1, 0, NULL, '3444', '344', '12', 4, 33, 'sdjhs', '4', '3444', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454555', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443435', 'Bank', 0, 0, '368436844', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(3, 0, 'InProgress', '', '$2y$10$Rqn6eH0Emb66S31Erc27AuQSqGf2cCr4YfanuYSYYYYhUuuO9VHiu', 'md motahar', 'hoseen', 'anik ', 767966790, 'abc3@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '3754764532', NULL, 1, 0, NULL, '3445', '344', '12', 0, 33, 'sdjhs', '4', '3445', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454556', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443436', 'Bank', 0, 0, '368436845', 'personal', 0, 'InTraining', '', 0, NULL, NULL, 1, '', NULL, '2018-07-30 09:50:29'),
(113, 0, 'InProgress', '', '$2y$10$KFKE5xKbMyUpNS0JBFz8TeztrSA5yz4a3/Yb.mJn3b20KLb1QkUDS', 'md. kamruzzaman', '', 'kamruzzaman', 717926593, 'abc4@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '4754764533', NULL, 1, 0, NULL, '3446', '344', '12', 0, 33, 'sdjhs', '4', '3446', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454557', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443437', 'Bank', 0, 0, '368436846', 'personal', 0, 'InTraining', '', 0, NULL, NULL, 2, '', NULL, '2018-07-30 09:50:29'),
(114, 0, 'InProgress', '', '$2y$10$uqEzAUEg6i72GFbsVDPVie3x1K/fUqawOPnCrgaJwQHTNZe6rkwAm', 'abc5', '', 'adfdf', 717966594, 'abc5@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '5754764534', NULL, 1, 0, NULL, '3447', '344', '12', 0, 33, 'sdjhs', '4', '3447', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454558', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443438', 'Bank', 0, 0, '368436847', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(115, 0, 'InProgress', '', '$2y$10$ke1xVadjMPX6NrLz9G82HOD/AxhLlBtd.8mGMQ7L4DswscAPcGrcm', 'abc6', 'hjgfjhd', 'jhdgjfd', 717966595, 'abc6@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '6754764535', NULL, 1, 0, NULL, '3448', '344', '12', 0, 33, 'sdjhs', '4', '3448', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454559', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443439', 'Bank', 0, 0, '368436848', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(116, 0, 'InProgress', '', '$2y$10$dYSTPEuu9RJG7va2bDIps.15Cu8bp6GBsrNtQxuDnffsbej9dnQU2', 'abc7', 'dffd', 'dfhjdf jdfjd jhgdfj hjgdfj ', 717966596, 'abc7@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '7754764536', NULL, 1, 0, NULL, '3449', '344', '12', 0, 33, 'sdjhs', '4', '3449', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454560', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443440', 'Bank', 0, 0, '368436849', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(117, 0, 'InProgress', '', '$2y$10$Wh4nG9FE3FuhoWTZW1FrFOqG08Q6L1Wqg9DqPkA3X8rM2pGesolGK', 'abc8', '', 'abc8', 717966597, 'abc8@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '8754764537', NULL, 1, 0, NULL, '3450', '344', '12', 0, 33, 'sdjhs', '4', '3450', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454561', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443441', 'Bank', 0, 0, '368436850', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(118, 0, 'InProgress', '', '$2y$10$ddRLHYm6TVM0d/qbfeLTKeXw0aRKqM74VWvpttEQO4yrIVmNQD2r2', 'abc9', '', 'abc9', 717966598, 'abc9@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '9754764538', NULL, 1, 0, NULL, '3451', '344', '12', 0, 33, 'sdjhs', '4', '3451', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454562', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443442', 'Bank', 0, 0, '368436851', 'personal', 0, '', '', 0, NULL, NULL, 2, '', NULL, NULL),
(119, 0, 'InProgress', '', '$2y$10$DROBwNf6hNAnJBbEcNs9Y.xzHwwNLCjfHGAz5x0odioIIOd1C9lT.', 'abc10', '', 'abc10', 717966599, 'abc10@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1054764539', NULL, 1, 0, NULL, '3452', '344', '12', 0, 33, 'sdjhs', '4', '3452', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454563', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443443', 'Bank', 0, 0, '368436852', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(120, 0, 'InProgress', '', '$2y$10$pYDL1ltEkv.6kLrP4K3je.MqLV9ibzCxXwN3L13tN0Ru9iK2PfBYS', 'abc11', '', 'abc11', 717966600, 'abc11@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1154764540', NULL, 1, 0, NULL, '3453', '344', '12', 0, 33, 'sdjhs', '4', '3453', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454564', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443444', 'Bank', 0, 0, '368436853', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(121, 0, 'InProgress', '', '$2y$10$S.29chJKeH5ecDFH2bE.nubtm1zeWHQ7c.WZeCGHsri6X74naIgkW', 'abc11', '', 'abc11', 717966601, 'abc110@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1254764541', NULL, 1, 0, NULL, '3454', '344', '12', 0, 33, 'sdjhs', '4', '3454', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454565', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443445', 'Bank', 0, 0, '368436854', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(122, 0, 'InProgress', '', '$2y$10$A3hz2ps79B9rlsQpzWLLauBSPPTgzCRzMjQmuGEj3Ppt5ab9DOC5a', 'abc12', '', 'abc12', 717966602, 'abc12@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1354764542', NULL, 1, 0, NULL, '3455', '344', '12', 0, 33, 'sdjhs', '4', '3455', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454566', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443446', 'Bank', 0, 0, '368436855', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(123, 0, 'InProgress', '', '$2y$10$WX2KFCrbHJMf9UWEmW/HcejYGTxge.7Jvj4QZ3d9lbESVOErCvB/2', 'abc13', '', 'abc13', 717966603, 'abc13@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1454764543', NULL, 1, 0, NULL, '3456', '344', '12', 0, 33, 'sdjhs', '4', '3456', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454567', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443447', 'Bank', 0, 0, '368436856', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(124, 0, 'InProgress', '', '$2y$10$D6dpSLDcw8q3cn138P926.WN2jxBUP6yNIYGsSc5FGyYpau9DPj9S', 'abc14', '', 'abc14', 717966604, 'abc14@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1554764544', NULL, 1, 0, NULL, '3457', '344', '12', 0, 33, 'sdjhs', '4', '3457', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454568', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443448', 'Bank', 0, 0, '368436857', 'personal', 0, '', '', 0, NULL, NULL, 1, '', NULL, NULL),
(125, 0, 'InProgress', '', '$2y$10$NWF846VlGPxSL6e6MuKwkOCYeaaY/Ckuav1AsTNRFtJE.qyJ.9yNC', 'abc15', '', 'abc15', 717966605, 'abc15@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1654764545', NULL, 1, 0, NULL, '3458', '344', '12', 0, 33, 'sdjhs', '4', '3458', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454569', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443449', 'Bank', 0, 0, '368436858', 'personal', 0, '', '', 0, NULL, NULL, 2, '', NULL, NULL),
(126, 0, 'InProgress', '', '$2y$10$EwdFfRd8mnKBH/O6GYbXRObAIDaBCZhOuFKem5DoiZ5vg9Ca4N0Oe', 'abc16', '', 'abc16', 717966606, 'abc16@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1754764546', NULL, 1, 0, NULL, '3459', '344', '12', 0, 33, 'sdjhs', '4', '3459', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454570', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443450', 'Bank', 0, 0, '368436859', 'personal', 0, 'InTraining', '', 0, NULL, NULL, 1, '', NULL, '2018-07-31 00:40:18'),
(127, 0, 'InProgress', '', '$2y$10$zF73Z..Hsp4To2Sm/XqIjOay6g8ZglZ7I3D1Nh.zAoyCy14kgM79m', 'abc17', '', 'abc17', 717966607, 'abc17@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '1854764547', NULL, 1, 0, NULL, '3460', '344', '12', 0, 33, 'sdjhs', '4', '3460', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454571', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443451', 'Bank', 0, 0, '368436860', 'personal', 0, 'InTraining', '', 0, NULL, NULL, 1, '', NULL, '2018-07-31 00:40:18'),
(128, 0, 'InProgress', '', '$2y$10$/IWBjMFvzEz0o7CJSS0UeOklqvQ6xqUFH8jSxtdvCe82OLiouKNjm', 'abc18', '', 'abc18', 717966608, 'abc18@gmail.com', 'sdgjsdj', 'gjjhfj', '4', '0000-00-00', '2054764548', NULL, 1, 0, NULL, '3461', '344', '12', 0, 33, 'sdjhs', '4', '3461', '344', '12', 0, 33, 'sdjhs', '4', 'dfdfdfd', 'fdfdfd', 1, 'dfdfdf', '454572', 'dfdfdf', 'dfdfdf', 1, 'dfdfdf', '3443452', 'Bank', 0, 0, '368436861', 'personal', 0, 'InTraining', '', 0, NULL, NULL, 1, '', NULL, '2018-07-31 00:40:19');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_nationalitys`
--

CREATE TABLE `tbl_nationalitys` (
...
--
-- Dumping data for table `tbl_nationalitys`
--
...
(4, 0, 'Bangladeshi', 0, 1, 'update', '2018-07-21 02:38:15', '2018-07-21 02:38:25');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_new_occupation`
--

CREATE TABLE `tbl_new_occupation` (
  `id_occupation` int(10) UNSIGNED NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_new_occupation`
--

INSERT INTO `tbl_new_occupation` (`id_occupation`, `user_id`, `occupation`, `last_action`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 1, 'aaaaaaa', 'create', '1', '2018-07-27 23:45:14', '2018-07-27 23:45:14'),
(2, 1, 'ccxzcxz', 'update', '1', '2018-07-29 07:35:28', '2018-07-29 07:35:36');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_new_organization`
--

CREATE TABLE `tbl_new_organization` (
...
--
-- Dumping data for table `tbl_new_organization`
--
...
--
-- Table structure for table `tbl_new_rating`
--

CREATE TABLE `tbl_new_rating` (
  `id_rating` int(10) UNSIGNED NOT NULL,
  `user_id` int(11) NOT NULL,
  `rating` tinyint(4) DEFAULT NULL,
  `lead_completed_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_action` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `tbl_new_rating`
--
...
--
-- Table structure for table `tbl_premise_ownership`
--

CREATE TABLE `tbl_premise_ownership` (
  `id_premise_ownership` int(10) UNSIGNED NOT NULL,
  `user_id` int(11) NOT NULL,
  `premise_ownership` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_deleted` int(11) NOT NULL DEFAULT '0',
  `is_active` int(11) NOT NULL DEFAULT '0',
  `last_action` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `tbl_premise_ownership`
--
...
--
-- Table structure for table `tbl_training_name`
--

CREATE TABLE `tbl_training_name` (
  `id_training_name` int(10) UNSIGNED NOT NULL,
  `user_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_action` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `tbl_training_name`
--

INSERT INTO `tbl_training_name` (`id_training_name`, `user_id`, `name`, `description`, `last_action`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 1, 'IFA Training', 'IFA Training Description', 'update', '1', '2018-07-27 23:45:25', '2018-07-29 04:07:27'),
(2, 1, 'Finance Training', 'Finance Description', 'update', '1', '2018-07-27 23:45:30', '2018-07-29 04:07:09'),
(3, 1, 'Lead Create', 'How to create Lead', 'create', '1', '2018-07-29 07:32:43', '2018-07-29 07:32:43'),
(4, 1, 'New Training', 'All applicant must be trained.', 'create', '1', '2018-07-30 05:26:35', '2018-07-30 05:26:35');
...
CREATE TABLE `training_schedules` (
  `id` int(10) UNSIGNED NOT NULL,
  `training_name_id` int(11) DEFAULT NULL,
  `training_schedule_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `training_schedules` (`id`, `training_name_id`, `training_schedule_name`, `start_date`, `end_date`, `start_time`, `end_time`, `is_active`, `is_delete`, `is_complete`, `created_at`, `updated_at`) VALUES
(2, 4, '0', '2018-07-31', '2018-08-07', '10:00', '14:00', 0, 0, 0, '2018-07-29 04:23:18', '2018-07-30 06:07:49'),
(3, 4, '0', '2015-02-10', '2018-08-12', '00:00', '12:03', 0, 0, 0, '2018-07-29 04:24:00', '2018-07-30 06:08:21'),
(4, 1, '0', '2018-07-05', '2018-07-19', '02:00', '02:00', 0, 0, 0, '2018-07-29 06:42:16', '2018-07-29 06:42:16'),
(5, 4, '0', '2018-07-30', '2018-08-23', '11:01', '14:01', 0, 0, 0, '2018-07-30 05:27:21', '2018-07-30 05:27:21'),
(6, 3, '0', '2018-07-06', '2018-07-19', '06:01', '02:00', 0, 0, 0, '2018-07-30 07:44:09', '2018-07-30 07:44:09');
...
--
-- Indexes for table `approved_exameens`
--
ALTER TABLE `approved_exameens`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `approved_trainees`
--
ALTER TABLE `approved_trainees`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_bangladesh_bank`
--
ALTER TABLE `tbl_bangladesh_bank`
  ADD PRIMARY KEY (`bank_id`);

--
-- Indexes for table `tbl_bangladesh_bank_branch`
--
ALTER TABLE `tbl_bangladesh_bank_branch`
  ADD PRIMARY KEY (`branch_id`);

--
-- Indexes for table `tbl_bangladesh_districts`
--
ALTER TABLE `tbl_bangladesh_districts`
  ADD PRIMARY KEY (`district_id`);

--
-- Indexes for table `tbl_bangladesh_divisions`
--
ALTER TABLE `tbl_bangladesh_divisions`
  ADD PRIMARY KEY (`division_id`);

--
-- Indexes for table `tbl_bangladesh_thanas`
--
ALTER TABLE `tbl_bangladesh_thanas`
  ADD PRIMARY KEY (`thana_id`);

--
-- Indexes for table `tbl_ifa_managment_filter_option`
--
ALTER TABLE `tbl_ifa_managment_filter_option`
  ADD PRIMARY KEY (`id_filter`);

--
-- Indexes for table `tbl_ifa_registrations`
--
ALTER TABLE `tbl_ifa_registrations`
  ADD PRIMARY KEY (`application_no`);

--
-- Indexes for table `tbl_nationalitys`
--
ALTER TABLE `tbl_nationalitys`
  ADD PRIMARY KEY (`id_nationality`);

--
-- Indexes for table `tbl_new_occupation`
--
ALTER TABLE `tbl_new_occupation`
  ADD PRIMARY KEY (`id_occupation`);

--
-- Indexes for table `tbl_new_organization`
--
ALTER TABLE `tbl_new_organization`
  ADD PRIMARY KEY (`id_organization`);

--
-- Indexes for table `tbl_new_rating`
--
ALTER TABLE `tbl_new_rating`
  ADD PRIMARY KEY (`id_rating`);

--
-- Indexes for table `tbl_premise_ownership`
--
ALTER TABLE `tbl_premise_ownership`
  ADD PRIMARY KEY (`id_premise_ownership`);

--
-- Indexes for table `tbl_training_name`
--
ALTER TABLE `tbl_training_name`
  ADD PRIMARY KEY (`id_training_name`);
...
--
-- AUTO_INCREMENT for table `approved_exameens`
--
ALTER TABLE `approved_exameens`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `approved_trainees`
--
ALTER TABLE `approved_trainees`
...
--
ALTER TABLE `mxp_menu`
  MODIFY `menu_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
--
...
--
ALTER TABLE `mxp_user_role_menu`
  MODIFY `role_menu_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=872;
--
-- AUTO_INCREMENT for table `tbl_bangladesh_bank`
--
ALTER TABLE `tbl_bangladesh_bank`
  MODIFY `bank_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tbl_bangladesh_bank_branch`
--
ALTER TABLE `tbl_bangladesh_bank_branch`
  MODIFY `branch_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `tbl_bangladesh_districts`
--
ALTER TABLE `tbl_bangladesh_districts`
  MODIFY `district_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
-- AUTO_INCREMENT for table `tbl_bangladesh_divisions`
--
ALTER TABLE `tbl_bangladesh_divisions`
  MODIFY `division_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `tbl_bangladesh_thanas`
--
ALTER TABLE `tbl_bangladesh_thanas`
  MODIFY `thana_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `tbl_ifa_managment_filter_option`
--
ALTER TABLE `tbl_ifa_managment_filter_option`
  MODIFY `id_filter` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tbl_ifa_registrations`
--
ALTER TABLE `tbl_ifa_registrations`
  MODIFY `application_no` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
--
-- AUTO_INCREMENT for table `tbl_nationalitys`
--
ALTER TABLE `tbl_nationalitys`
  MODIFY `id_nationality` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tbl_new_occupation`
--
ALTER TABLE `tbl_new_occupation`
  MODIFY `id_occupation` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_new_rating`
--
ALTER TABLE `tbl_new_rating`
  MODIFY `id_rating` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tbl_premise_ownership`
--
ALTER TABLE `tbl_premise_ownership`
  MODIFY `id_premise_ownership` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tbl_training_name`
--
ALTER TABLE `tbl_training_name`
  MODIFY `id_training_name` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
