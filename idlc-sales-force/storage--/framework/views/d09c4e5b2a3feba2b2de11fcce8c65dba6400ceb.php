					...
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(Route('acc_class_update_action')); ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_head_name" required >
                                        ...
                                        <?php else: ?>
                                        	<?php $__currentLoopData = $accounts_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accounts_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                                            <option value="<?php echo e($accounts_head->accounts_heads_id); ?>" <?php echo e(($acc_class_head->accounts_heads_id == $accounts_head->accounts_heads_id)? 'selected' : ''); ?>><?php echo e($accounts_head->head_name_type.'('.$accounts_head->account_code.')'); ?></option>
	                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_sub_head_name" required >
                                        ...
                                        <?php else: ?>
											<?php $__currentLoopData = $accounts_sub_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accounts_sub_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                                            <option value="<?php echo e($accounts_sub_head->accounts_sub_heads_id); ?>" <?php echo e(($acc_class_head->accounts_sub_heads_id == $accounts_sub_head->accounts_sub_heads_id)? 'selected' : ''); ?>><?php echo e($accounts_sub_head->sub_head); ?></option>
	                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text" class="form-control input_required" name="acc_class_name" autocomplete="off" value="<?php echo e($acc_class_head->head_class_name); ?>">
								</div>
							</div>
				            ...
				            <?php echo e(Session::forget('acc_class_name')); ?>
