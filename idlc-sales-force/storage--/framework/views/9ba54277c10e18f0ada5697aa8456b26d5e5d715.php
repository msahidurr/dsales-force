<?php $__env->startSection('page_heading','Add new Store'); ?>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(Route('add_store_action')); ?>">
							...
							<div class="form-group">
								<label class="col-md-4 control-label">Enter Store Name</label>
								<div class="col-md-6">
							...
							<div class="form-group">
								<label class="col-md-4 control-label">Enter Store Location</label>
								<div class="col-md-6">
