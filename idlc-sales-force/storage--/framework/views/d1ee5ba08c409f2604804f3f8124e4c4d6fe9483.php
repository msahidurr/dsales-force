...
<div class="col-sm-8 col-sm-offset-2">
    <form method="post" action="<?php echo e(route('ifa_registration.store')); ?>">
        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
        <input type="hidden" name="application_no" value="<?php echo e($application_no); ?>">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group<?php echo e($errors->has('national_id_card_no') ? ' has-error' : ''); ?>">
                                    ...
                                    <span class="help-block"><?php echo e($errors->first('national_id_card_no')); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.idlc_aml.app', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>