<?php $__env->startSection('page_heading','Assign Role'); ?>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="all_checkbox col-sm-12" id="all_checkbox">
                            <div style="float: left; width: 100%; margin-bottom: 20px; ">
                                <a style="cursor: pointer;" id="selectAllcheckBox">Select All</a><br>
                                <a style="cursor: pointer;" id="unselectAllcheckBox">Unselect All</a>
                            </div>
