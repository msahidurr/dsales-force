<?php $__env->startSection('page_heading','Vat Tax List'); ?>
...
<div class="create_form_btn" style="margin-bottom: 20px;">
    <a href="<?php echo e(Route('add_vat_tax_view')); ?>">
        <button class="btn btn-success">Add Vat Tax</button>
    </a>
</div>
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $vatTaxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vattax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a class="delete_id" href="<?php echo e(Route('delete_vat_tax_action')); ?>/<?php echo e($vattax->id); ?>" > <?php echo $__env->make('widgets.button', array('class'=>'danger', 'value'=>'Delete&nbsp;'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> </a>
                                </td>
                            </tr>    
