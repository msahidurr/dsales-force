<?php $__env->startSection('page_heading','Add new Product'); ?>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(Route('add_product_action')); ?>">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Select Product Group</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Enter Product name</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Select Packet details</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Enter Product code</label>
                                <div class="col-md-6">
