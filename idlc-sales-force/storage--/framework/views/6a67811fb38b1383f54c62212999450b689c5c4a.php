			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(Route('acc_sub_class_update_action')); ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_head_class_name" required >
                                        ...
                                        <?php else: ?>
                                        	<?php $__currentLoopData = $acc_class; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc_clas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                                            <option value="<?php echo e($acc_clas->mxp_acc_classes_id); ?>" <?php echo e(($acc_class_sub_head->mxp_acc_classes_id == $acc_clas->mxp_acc_classes_id)? 'selected' : ''); ?>><?php echo e($acc_clas->head_class_name); ?></option>
	                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
                                    </select>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_head_name" required >
                                        ...
                                        <?php else: ?>
											<?php $__currentLoopData = $accounts_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accounts_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                                            <option value="<?php echo e($accounts_head->accounts_heads_id); ?>" <?php echo e(($acc_class_sub_head->accounts_heads_id == $accounts_head->accounts_heads_id)? 'selected' : ''); ?>><?php echo e($accounts_head->head_name_type.'('.$accounts_head->account_code.')'); ?></option>
	                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>                                        
                                    </select>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_sub_head_name" required >
                                        ...
                                        <?php else: ?>
											<?php $__currentLoopData = $accounts_sub_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accounts_sub_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                                            <option value="<?php echo e($accounts_sub_head->accounts_sub_heads_id); ?>" <?php echo e(($acc_class_sub_head->accounts_sub_heads_id == $accounts_sub_head->accounts_sub_heads_id)? 'selected' : ''); ?>><?php echo e($accounts_sub_head->sub_head); ?></option>
	                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
                                    </select>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text" class="form-control input_required" name="acc_sub_class_name" autocomplete="off" value="<?php echo e($acc_class_sub_head->head_sub_class_name); ?>">
								</div>
							</div>
