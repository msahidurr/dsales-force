<?php $__env->startSection('page_heading','Update Role'); ?>
            ...
            <form role="form" action="<?php echo e(Route('role_update_action')); ?>/" method="post">
                ...
                <div class="form-group">
                    <select class="form-control" name="is_active" required>
                        <option value="0" <?php echo e(($companysAllRoles[0]->is_active == 0)? 'selected' : ''); ?>>Not Active</option>
                        <option value="1" <?php echo e(($companysAllRoles[0]->is_active == 1)? 'selected' : ''); ?>>Active</option>
                </div>
