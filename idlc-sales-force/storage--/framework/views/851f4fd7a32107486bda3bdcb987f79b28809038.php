    ...
    <div class="modal-dialog" style="width: 1000px;">
        <div class="modal-content">
            <div class="modal-header">
                <a href="<?php echo e(Route('lc_product_purchase_search_list')); ?>" class="btn btn-danger pull-right" data-dismiss="modal" aria-label="Close" id="close_lc_purchase_update_modal">Cancel</a>
